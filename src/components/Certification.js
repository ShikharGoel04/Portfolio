...
export default function Certification(){
    ...
    <div style={{backgroundColor:'lightyellow',paddingBottom:'10%'}}>
        ...
        <img style={{marginLeft:'-4%'}} src={GoogleCloud} height="20%" width="25%"/> <h4 style={{marginLeft:'18%',marginTop:'-12%',color:'darkblue'}}>  November,2021 - Google Cloud Certified - Associate Cloud Engineer
       Issuing Organization - Google Cloud</h4><h4 style={{marginLeft:'18%',marginTop:'-4%',color:'darkgoldenrod'}}>Issuing Organization - Google Cloud</h4>
       ...
       <img style={{marginLeft:'2%'}} src={coursera} height="80" width="80"/> <h4 style={{marginLeft:'18%',marginTop:'-10%',color:'darkblue'}}>September,2020  - Full-Stack Web Development with React</h4>
